    ...
    ui(new Ui::Beginning)
{
    ...
    ui->AHU->setPixmap(QPixmap::fromImage(*image).scaled(ui->AHU->size(), Qt::KeepAspectRatio,Qt::SmoothTransformation));
    ...
    connect(ui->rule,&QPushButton::clicked,this,[this](){rule->exec();});
    connect(ui->worker,&QPushButton::clicked,this,[this](){worker->exec();});
